...
// ============================================
// HOMEPAGE BEFORE/AFTER COMPARISON SLIDERS
// ============================================
const comparisonSliders = document.querySelectorAll('.before-after-item');
if (comparisonSliders.length > 0) {
    comparisonSliders.forEach(item => {
        const slider = item.querySelector('.comparison-range');
        const beforeContainer = item.querySelector('.comparison-before');
...
// ============================================
const portfolioFilterBtns = document.querySelectorAll('.portfolio-section .filter-btn');
...
// ============================================
// PORTFOLIO MODAL FOR BEFORE/AFTER
// ============================================
const portfolioItems_Modal = document.querySelectorAll('.portfolio-item');
if (portfolioItems_Modal.length > 0 && modal) {
    portfolioItems_Modal.forEach((item) => {
        item.addEventListener('click', () => {
            const beforeSources = item.getAttribute('data-before')
                .split(',')
                .map((source) => source.trim())
                .filter(Boolean);
            const afterSrc = item.getAttribute('data-after') || item.querySelector('img').src;
